...
class RectangularRoom:
    ...
    def intersects(self, other: RectangularRoom) -> bool:
        """
        :param other: The room to check for overlap.
...
def tunnel_between(
    ...
    """
    Return an L-shaped tunnel between the points provided.
    :param start:
    :param end:
    :return:
    """
...
def generate_dungeon(
    ...
    for r in range(max_room_attempts):
        ...
        # RectangularRoom class makes rects easier to work with
